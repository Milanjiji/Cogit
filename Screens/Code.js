  ...
  const handleWebViewLoad = async () => {
    ...
    return(
        ...
        <WebView
                    ...
                    <html lang="en">
                    <head>
                        <title>Online C / C++ Compiler</title>
                        ...
                        <meta name="description" content="Build and Run your code instantly. OnlineCPP is a quick and easy tool that helps you to build, compile, test your programs online.">
                        <meta name="keywords" content="online c compiler, online c++ compiler, online c++ ide, online c ide, online c++ editor, online c editor, compile c online, compile c++ online">
                        ...
                        <link rel="icon" type="image/png" href="https://www.online-cpp.com/favicon.png">
                    ...
                    <!-- Hotjar Tracking Code for https://online-cpp.com -->
                    <!-- <script>
                        (function(h,o,t,j,a,r){
                            h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
                            h._hjSettings={hjid:2000197,hjsv:6};
                    ...
                    <!-- <nav class="nav navbar-top primary">
                        <a  href="/"><img src="assets/images/ide_logo1.png" alt="Online IDE" class="nav_logo" width="185" height="40"></a>
                    </nav> -->
                    
                    <nav class="nav navbar-top primary">
                        <h2 class="nav_logo">
                        <i class="fas fa-code"></i>
                            <span>Online CPP <sup>beta</sup> </span>
                    </h2>
                    ...
                    <div class="container" id="container">
                        <div id="header-control">
                            ...
                            <div class="ui fluid selection dropdown" id="lang-select" data-toggle="popover" data-trigger="manual" data-placement="left" data-content="Select the programming language">
                                ...
                                <div class="menu">
                                    <div class="item" data-value="c"><img class="ui mini image" alt="C" src="https://www.online-cpp.com/assets/images/languages/c.svg">C</div>
                                    <div class="item" data-value="cpp"><img class="ui mini image" alt="C++" src="https://www.online-cpp.com/assets/images/languages/cpp.svg">C++</div>
                                </div>
                            </div>
                        ...
                        <div id="info">
                            <h1 class="header1">Online C / C++ Compiler</h1>
                            <p class="para">Online CPP is a super fast and instant tool that allows you run the C / C++ programming laguages on the fly in your favourite browser without need to worry about the installation and setting up the programming environment in your system. This tool is strongly backed by its blazing fast compiler that makes it one of the quickest, robust and powerful online compilers on the internet. You can build, run & share your C / C++ programs online usng this tool for free. The program / project that you have built can be saved online by using the <strong>SHARE</strong> option that enables you to access your code anywhere using internet.</p>
                    
                            <h2 class="header1">About C</h2>
                            <p class="para">C is a general purpose programming language, one of the powerful language that has inspired and influenced many other languages like Java, Python, Perl, Java, PHP, Ruby. C is widely used to build operating systemns and embedded system applications. Its origin is closely tied to the development of UNIX operating system. Compilers and Interpreter of many other programming languages are implemented using C. Its basic features and the control structures are directly and indirectly adopted by other programming languages.</p>
                            <p class="para">C was originally developed at Bell Labs by Dennis Ritchie between 1972 and 1973. It was successor to the programming language B. Around 1980, C has become most widely used programming language. C provides contructs that maps the high level program to machine instrutions more efficiently which makes it one of the fastest in terms of code execution.</p>
                    
                            <p class="para">To learn more about C program check out some of the following links.</p>
                    
                            <ul>
                                <li><a target="_blank" title="Visit Wikipedia's C Entry" href="https://en.wikipedia.org/wiki/C_(programming_language)">Wikipedia - C&ensp;<i class="fas fa-external-link-alt"></i></a></li>
                                <li><a target="_blank" title="Visit w3schools.com's C Tutorial" href="https://www.geeksforgeeks.org/c-programming-language/" rel="nofollow">geeksforgeeks.org - C Tutorial&ensp;<i class="fas fa-external-link-alt"></i></a></li>
                                <li><a target="_blank" title="Visit Programiz's C Tutorial" href="https://www.programiz.com/c-programming" rel="nofollow">programiz.com - C Tutorial&ensp;<i class="fas fa-external-link-alt"></i></a></li>
                            </ul>
                    
                            <h2 class="header1">Why learn C ?</h2>
                            <ul>
                                <li>It helps you to understand how a computer works</li>
                                <li>Almost all other programming languages are built from C and can interface with it</li>
                                <li>It will become easier to learn other programming languages, once you understand the C program</li>
                                <li>It is an efficient programming language</li>
                                <li>It is used in development of operating systems, system applications, Iot applications</li>
                            </ul>
                    
                            <h2 class="header1">Features of this tool</h2>
                            <ul>
                                <li>Simple & Clean Design, Lightweight, Easy & Fast</li>
                                <li>Interactive program execution which makes the user to give program inputs at real time</li>
                                <li>Helpful for beginners to learn and practice programs</li>
                        ...
                        <br/><br/>
                        <p id="footer">© 2023 online-cpp.com | <a href="about" target="_blank">About</a> | <a href="terms_and_conditions" target="_blank">Terms & Conditions</a> | <a href="privacy_policy" target="_blank">Privacy Policy</a></p>
                    </div>
                    ...
                    <div class="modal" tabindex="-1" role="dialog" id="aboutSiteModal">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                              <h2 class="modal-title"><strong>About online-cpp.com</strong></h2>
                            </div>
                    
                            <div class="modal-body abountModalBody">
                                <p>Online CPP is a super fast and instant tool that allows you run the C / C++ programming laguages on the fly in your favourite browser without need to worry about the installation and setting up the programming environment in your system. This tool is strongly backed by its blazing fast compiler that makes it one of the quickest, robust and powerful online compilers on the internet. You can build, run & share your C / C++ programs online usng this tool for free. The program / project that you have built can be saved online by using the <strong>SHARE</strong> option that enables you to access your code anywhere using internet.</p>
                            ...
                            <div class="modal-footer">
                              <p>&emsp;Copyright © 2020 online-ide.com</p>
                    ...
                    <script type="text/javascript">
                        ...
                        var csrf_token = '2dd4595e5b5367bf59262c3319050cc5'
                        ...
                        let theme = localStorage.getItem('theme') !== undefined && localStorage.getItem('theme') !== null ? localStorage.getItem('theme') : 'dark'
                        ...
                        editor.setTheme("ace/theme/tomorrow_night_bright"); // Remove this line, as it sets the theme again
                        document.getElementById('toggle-theme').innerHTML = '<i class="fas fa-sun fa-lg"></i>';
